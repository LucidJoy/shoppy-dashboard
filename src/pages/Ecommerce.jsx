          ...
          {earningData.map((item) => (
            ...
            >
              <button
                ...
                className='text-2xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl transition-all duration-150'
              >
                {item.icon}
              </button>
              <p className='mt-3'>
            ...
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p className='flex items-center'>
                  ...
                  <span
                    className='p-1.5 rounded-full text-white bg-green-400 ml-3
                  text-xs'
                  >
                    23%
                  </span>
