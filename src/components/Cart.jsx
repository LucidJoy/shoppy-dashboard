...
const Cart = () => {
  ...
  return (
    <div className='bg-half-transparent backdrop-blur-sm w-full fixed nav-item top-0 right-0 '>
      <div className='float-right h-screen  duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8'>
        <div className='flex justify-between items-center'>
          ...
          <button
            type='button'
            //FIXME : md:hidden
            className='text-xl text-gray-400 hover:drop-shadow-xl rounded-full p-3 hover:bg-light-gray block'
